...
def save_model_CNN(model: Model = None,
    ...
    mlflow_experiment = 'mnist_experiment_bianca_CNN'
    mlflow_model_name = 'mnist_bianca_CNN'
...
fig.savefig("results/CNN_bianca.png")

#save in bucket
BUCKET_NAME = "brain-mnist"
fig.savefig("results/CNN_bianca.png") #save png locally
upload_blob(BUCKET_NAME, f'results/CNN_bianca.png', f"results/CNN_bianca.png")
